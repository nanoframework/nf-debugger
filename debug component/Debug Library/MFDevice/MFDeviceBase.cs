...
{
    public abstract class MFDeviceBase
    {
        /// <summary>
        /// .NETMF debug engine
        /// </summary>
        ...
        // timer to "suicide" MF device after the hardware instance has been removed or detected as inactive by the port where it was connected
        ...
        /// <summary>
        /// Start count down to dispose MF device. The dispose will occur after 2 seconds.
        /// </summary>
        ...
        /// <summary>
        /// Start count down to dispose MF device. The dispose will occur after the timeToDispose argument is elapsed.
        /// </summary>
        ...
        public async Task<Tuple<uint, bool>> DeployAsync(StorageFile srecFile, StorageFile signatureFile, CancellationToken cancellationToken, IProgress<ProgressReport> progress = null)
        {
            ...
            var parseResult = await SRecordFile.ParseAsync(srecFile, signatureFile != null ? signatureFile : null);
